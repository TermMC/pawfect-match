...
import { faUser, faCalendar, faEnvelope, faPenToSquare, faCircleCheck, faIdBadge, faHourglassStart } from "@fortawesome/free-solid-svg-icons"
...
export default function UserProfile({user_id_main}) {
  ...
  if (loading) return <div className="loading">Loading <FontAwesomeIcon icon={faHourglassStart} /></div>
          ...
          <form id="pform" onSubmit={handleSubmit}>
            <fieldset>
              ...
              <div className="input-icon-wrapper">
                <input id="name" type="text" name="name" placeholder="Full Name" defaultValue={account.name } onChange={handleInputChange}/>
                <FontAwesomeIcon icon={faUser} className="input-icon"/>
                {errors.name && <span className="error-message">{errors.name}</span>}
              </div>
              <label htmlFor="username">Username</label>
              <div className="input-icon-wrapper">
                <input id="username" type="text" name="username" placeholder="Username" defaultValue={account.username} onChange={handleInputChange}/>
                <FontAwesomeIcon icon={faIdBadge} className="input-icon"/>
                {errors.username && <span className="error-message">{errors.username}</span>}
              </div>
              <label htmlFor="email">Email</label>
              <div className="input-icon-wrapper">
                <input id="email" type="email" name="email" placeholder="Email" defaultValue={account.email} onChange={handleInputChange}/>
              ...
              <div className="input-icon-wrapper">
              <input type="date" name="date_of_birth" id="dob" defaultValue={account.date_of_birth} onChange={handleInputChange} />
              ...
              <div className="input-icon-wrapper">
                <textarea id='biofield' name="bio" rows='10' cols='100' defaultValue={account.bio} onChange={handleInputChange} />
